...
class Join:
    ...
    def join_files(self, file1, file2):
        ...
        :rtype: tuple
        """
        folder1_path = os.path.join(self.folder1_path, "C:/Users/henry/PycharmProjects/DataBase/Backend/disco", file1)
        ...
        folder2_path = os.path.join(self.folder2_path, "C:/Users/henry/PycharmProjects/DataBase/Backend/disco", file2)
    ...
    def perform_join(self, filtered_folder, filtered_rows, string_):
        """
